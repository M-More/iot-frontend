        ...
        <div class="eveConfQuire-div">
          <el-form class="eveConfQuire-form">
            ...
            <el-row class="eveConfQuire-row-2">
              ...
              <el-col :span="8">
                <el-form-item>
                  <el-input v-model="inputTitle" placeholder="请输入事件级别"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8" >
                <el-form-item style="text-align: right;">
                  <el-button class="el-button1" type="warning" @click="eveConfQuery">查询</el-button>
              ...
              <el-table
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    <el-button class="eveConfUpdateButt" type="text" @click="eveConfUpdate">修改信息</el-button>
