  ...
  <div class="equipTypeList">
        ...
        <div class="equipTypeQuire-div">
          <el-form class="equipTypeQuire-form">
            ...
            <el-row class="equipTypeQuire-row-2">
              ...
              <el-col :span="8">
                <el-form-item>
                  <el-input v-model="inputTitle" placeholder="请输入设备类型编号"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8" >
                <el-form-item style="text-align: right;">
                  <el-button class="el-button1" type="warning" @click="equipTypeQuery">查询</el-button>
    ...
    <div class="detailList">
      <el-row>
        ...
        <el-col :span="8" >
          <el-button class="el-button1" type="success" @click="equipTypeAdd">新增</el-button>
        </el-col>
        <el-col :span="8" >
      ...
      <div>
        <el-tabs style="background: white; line-height: 10px" v-model="activeName" type="card" @tab-click="handleClick">
          <el-tab-pane label="设备类型信息" name="first">
            <template>
              <el-table
                  class="el-table-list"
                  :data="tableData"
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope">
                    <el-button class="equipTypeUpdateButt" type="text" @click="equipTypeUpdate">修改信息</el-button>
  ...
  data() {
    return {
      ...
      tableData1: [{
        equipTypeName: '供应商1',
        equipTypeId: 1,
        equipTypeNote: '供应商1联系人1',
        action:'按钮',
      }, {
        equipTypeName: '供应商2',
        equipTypeId: 2,
        equipTypeNote: '供应商2联系人1',
        action:'按钮',
      },{
        equipTypeName: '供应商3',
        equipTypeId: 3,
        equipTypeNote: '供应商3联系人1',
        action:'按钮',
      },{
        equipTypeName: '供应商4',
        equipTypeId: 4,
        equipTypeNote: '供应商4联系人1',
        action:'按钮',
      },{
        equipTypeName: '供应商5',
        equipTypeId: 5,
        equipTypeNote: '供应商5联系人1',
        action:'按钮',
      }],
      dialogVisible: false,
      inputTitle: '',
